-- =============================================================================
-- Gypsum Sales CRM — Companies, Users, Roles, and Permissions
-- =============================================================================
...
CREATE TRIGGER trg_roles_prevent_hard_delete
...
CREATE TRIGGER trg_permissions_prevent_hard_delete
...
CREATE TRIGGER trg_role_permissions_prevent_hard_delete
...
CREATE TRIGGER trg_user_roles_prevent_hard_delete
